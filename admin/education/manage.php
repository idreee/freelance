...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title">Боловсролын түвшин</h5>
		</div>
		<div class="card-body">
			<form id="education">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="form-group">
							<label for="" class="control-label">Сар</label>
					...
					<div class="col-sm-4">
						<div class="form-group">
							<label for="" class="control-label">Жил</label>
		...
		<div class="card-footer">
			...
			<a class="btn btn-primary btn-sm" href="./?page=education">Цуцлах</a>
		</div>
	</div>
</div>
