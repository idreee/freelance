...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title">Холбоо барих мэдээлэл</h5>
		</div>
		<div class="card-body">
			<form id="contact">
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="control-label">Имэйл</label>
							<div class="input-group">
			                    <div class="input-group-prepend">
						...
						<div class="form-group">
							<label for="" class="control-label">Facebook холбоос</label>
							<div class="input-group">
			                    <div class="input-group-prepend">
						...
						<div class="form-group">
							<label for="" class="control-label">Twitter холбоос</label>
							<div class="input-group">
			                    <div class="input-group-prepend">
						...
						<div class="form-group">
							<label for="" class="control-label">холбоос</label>
							<div class="input-group">
			                    <div class="input-group-prepend">
		...
		<div class="card-footer">
			<button class="btn btn-primary btn-sm" form="contact">Хадгалах</button>
		</div>
	</div>
</div>
