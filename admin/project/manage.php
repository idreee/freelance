...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			<form id="project">
				<div class="row" class="details">
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label for="" class="control-label">Үйлчлүүлэгч</label>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							<label for="" class="control-label">Дүгнэлт</label>
		...
		<div class="card-footer">
			...
			<a class="btn btn-primary btn-sm" href="./?page=project">Цуцлах</a>
		</div>
	</div>
</div>
