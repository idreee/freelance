...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group col-xs-7">
							<label for="" class="control-label">Эхэлсэн</label>
					...
					<div class="col-sm-6">
						<div class="form-group col-xs-7">
							<label for="" class="control-label">Дууслаа</label>
						...
						<div class="form-group col-xs-5">
							...
							<br>
							<label for="present"><input type="checkbox" name="present" id="present">Одоогийн</label>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							<label for="" class="control-label">Тодорхойлолт</label>
		...
		<div class="card-footer">
			...
			<a class="btn btn-primary btn-sm" href="./?page=work">Цуцлах</a>
		</div>
	</div>
</div>
